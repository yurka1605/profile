...
/* harmony import */ var _module_functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module.functions */ "./src/module.functions.js");
/* harmony import */ var _module_vars__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module.vars */ "./src/module.vars.js");
...
function () {
  ...
  _createClass(Profile, [{
    ...
    value: function init() {
      ...
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["mainNavigation"].addEventListener('click', function (event) {
        _this.currentUserAgent !== true ? Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["getActiveTab"])(event.target.dataset.tabId) : Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["getActiveTab"])(event.target.getAttribute('data-tab-id')); // for IE 10 и Edge
      }); // Активация Popup

      _module_vars__WEBPACK_IMPORTED_MODULE_1__["hobbiesControl"].addEventListener('click', function (event) {
        return Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["activePopup"])(event);
      });
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["closePopup"].addEventListener('click', function (event) {
        return Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["activePopup"])(event);
      }); // Управление интересами

      _module_vars__WEBPACK_IMPORTED_MODULE_1__["fieldEnterHobby"].addEventListener('input', function (event) {
        Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["validFields"])(event.target, /[^A-Za-zА-Яа-я\s\-]/g, '', 'Телефон не может состоять из букв!');
      });
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["addHobby"].addEventListener('click', function (event) {
        var inputValue = _module_vars__WEBPACK_IMPORTED_MODULE_1__["fieldEnterHobby"].value.toLowerCase();
        inputValue.trim() !== '' ? Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["addHobbies"])(inputValue, event) : Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["showMessage"])('Enter name hobby', 'danger');
      });
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["userHobby"].addEventListener('click', function (event) {
        if (event.target.className !== 'userHobby') Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["deleteHobby"])(event.target.innerHTML);
      }); //Изменение данных профиля

      _module_vars__WEBPACK_IMPORTED_MODULE_1__["mainInfoUser"].addEventListener('click', function (event) {
        if (event.target.tagName === 'INPUT') {
          _this.currentUserAgent !== true ? Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["changeInfo"])(event.target.dataset.nameField, event) : Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["changeInfo"])(event.target.getAttribute('data-name-field'), event); // for IE 10
        }
      });
    } //getData
    ...
    value: function getDataUser() {
      this.currentUserAgent ? _module_functions__WEBPACK_IMPORTED_MODULE_0__["fetcherForIE"].call(this) : _module_functions__WEBPACK_IMPORTED_MODULE_0__["fetcherForAll"].call(this); //add context for Opera
    } //Parse
    ...
    value: function renderDataUsers() {
      var user = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _module_vars__WEBPACK_IMPORTED_MODULE_1__["defaultSettings"];
      ...
      Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["getActiveTab"])(tabId); // render основного профиля

      _module_vars__WEBPACK_IMPORTED_MODULE_1__["imageUser"].src = user.picture;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["imageUser"].title = _module_vars__WEBPACK_IMPORTED_MODULE_1__["imageUser"].alt = user.fullName;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["fullNameUser"].value = user.fullName;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["cityUser"].value = user.city;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["familyUser"].value = user.info.family;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["phoneNumber"].value = user.info.phone;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["emailUser"].value = user.info.email;
      _module_vars__WEBPACK_IMPORTED_MODULE_1__["userHobby"].innerHTML = '';
      hobbies.forEach(function (hobby) {
        Object(_module_functions__WEBPACK_IMPORTED_MODULE_0__["createHobbyDomNode"])(hobby, 'after');
      }); // Render списка друзей

      _module_vars__WEBPACK_IMPORTED_MODULE_1__["userFriends"].innerHTML = '';
      friends.forEach(function (friend) {
        ...
        _module_vars__WEBPACK_IMPORTED_MODULE_1__["userFriends"].appendChild(newFriend);
      });
      setTimeout(function () {
        _module_vars__WEBPACK_IMPORTED_MODULE_1__["wrapper"].classList.remove('filter');
        _module_vars__WEBPACK_IMPORTED_MODULE_1__["spinner"].style.display = _module_vars__WEBPACK_IMPORTED_MODULE_1__["overlay"].style.display = 'none';
      }, 1000);
    }
  }, {
    key: "userProfile",
...
var profile = new Profile(localStorage, _module_vars__WEBPACK_IMPORTED_MODULE_1__["URL"], _module_vars__WEBPACK_IMPORTED_MODULE_1__["currentUserAgent"]);
profile.init();
...
/* harmony import */ var _module_vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module.vars */ "./src/module.vars.js");
